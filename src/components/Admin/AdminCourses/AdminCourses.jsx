    ...
    return (
        <Grid css={{ cursor: `url(${cursor}), default` }} minH={'100vh'} templateColumns={['1fr', '5fr 1fr']}>
            ...
            <Box p={['0', '8']} overflowX="auto">
                ...
                <CourseModal isOpen={isOpen} onClose={onClose}  id={"idisiisdidsj"} courseTitle="React Course" deleteButtonHandler={deleteLectureButtonHandler} addLectureHandler={addLectureHandler} />
