...
const Founder = ()=>(
    <Stack direction={['column','row']} spacing={['4','16']} padding={'8'}>
        <VStack>
            <Avatar src="https://media.licdn.com/dms/image/C5603AQFqoEbRB65IeQ/profile-displayphoto-shrink_400_400/0/1640015773599?e=1683763200&v=beta&t=lsNZ_Ov9Smijq4OiC7_LhfMSPKJ3sK-SN7Gf026J4AA" boxSize={['40','48']}/>
            <Text children="Co-Founder" opacity={0.7}/>
        </VStack>

        <VStack  justifyContent={'center'} alignItems={['center','flex-start']}>
            <Heading children="Yash Giri" size={['md','xl']}/>
            <Text textAlign={['center','left']} children={`Hi, I am a Aam Adami and a teacher. Our mission is to provide quality content at reasonable price.`}/>
    ...
    <Container maxW={"container.lg"} padding="16" boxShadow={'lg'} >
        ...
        <Stack m="8" direction={["column","row"]} alignItems="center">
            ...
            <Text fontFamily={"cursive"} m="8" textAlign={['center','left']}>
                ...
                (means bina paise ke kuch nhi hai yaha)
            </Text>
